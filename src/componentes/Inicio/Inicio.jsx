                ...
                <div className="flex items-center justify-around m-10 flex-wrap sm:flex-nowrap">
                    ...
                    <div className="w-full sm:w-1/2 flex">
                        <div className="flex flex-col justify-center items-center w-full sm:w-80 mx-auto my-auto">
                            ...
                            <div >
                                <Link to="/professionals" className="m-4 p-3 text-white bg-light-green hover:bg-primary rounded-3xl w-80 flex justify-center content-center duration-500">Comienza ahora</Link>
                            </div>
                        </div>
                    </div>
